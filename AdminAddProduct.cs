...
namespace m2
{
    public partial class AdminAddProduct : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Debugging: Show parsed values for validation
            MessageBox.Show($"Parsed Values:\nUnitPrice: {unitPrice}\nQuantity: {quantity}\nRating: {rating}",
    ...
    WHERE c.CategoryName = @CategoryName";
            ...
            // SQL Insert query
            string query = @"
    INSERT INTO Product (CategoryID, ProductName, Image_url, UnitPrice, Quantity, Brand, ShippingOptions, Rating)
    VALUES (@CategoryID, @ProductName, @ImageUrl, @UnitPrice, @Quantity, @Brand, @ShippingOptions, @Rating)";
